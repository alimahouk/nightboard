...
@implementation SHSettingsViewController_Corporate
...
- (void)loadView
{
    ...
    browser = [[UIWebView alloc] initWithFrame:CGRectMake(0, 0, appDelegate.screenBounds.size.width, appDelegate.screenBounds.size.height - 64)];
