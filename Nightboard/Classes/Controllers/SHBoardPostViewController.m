...
- (void)saveEdits
{
    ...
    [manager POST:[NSString stringWithFormat:@"http://%@/theboard/api/editboardpost", SH_DOMAIN] parameters:parameters success:^(AFHTTPRequestOperation *operation, id responseObject) {
...
- (void)deletePost
{
    ...
    [manager POST:[NSString stringWithFormat:@"http://%@/theboard/api/deleteboardpost", SH_DOMAIN] parameters:parameters success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSArray *viewControllers = self.navigationController.viewControllers;
        id sender = [viewControllers objectAtIndex:0];
...
- (void)recordView
{
    ...
    [manager POST:[NSString stringWithFormat:@"http://%@/theboard/api/recordboardpostview", SH_DOMAIN] parameters:parameters success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSArray *viewControllers = self.navigationController.viewControllers;
        id sender = [viewControllers objectAtIndex:0];
