...
- (void)viewWillDisappear:(BOOL)animated
{
    ...
    else if ( [viewControllers indexOfObject:self] == NSNotFound ) // View is disappearing because it was popped from the stack.
    {
        ...
        {
            appDelegate.mainView.windowCompositionLayer.scrollEnabled = YES;
            appDelegate.mainView.windowCompositionLayer.contentSize = CGSizeMake(appDelegate.screenBounds.size.width * 3 - 40, appDelegate.screenBounds.size.height);
        }
        else
        {
